...
public class RNUtil {
    ...
    /**
     * Converts a ReadableArray into a String[]
     *
     * @param readableArray the ReadableArray to parse
     * @return a String[] if applicable
     */
    @Nullable
    public static String[] toArrayOfString(@Nullable ReadableArray readableArray) {
        if (readableArray == null) {
            return null;
        }
        ...
        for (int index = 0; index < readableArray.size(); index++) {
            if (readableArray.getType(index) == ReadableType.String) {
